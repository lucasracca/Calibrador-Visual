...
from concentrador import *
from comunicacion1 import *
...
class ControlMainWindows(QtWidgets.QMainWindow):
    ...
    intentos = 0
    comm = 0
    config = {'IP': '192.168.0.245', "Sentido": "ForWard", "Modo": "RD", "Tiempo" : "100"}
    archivo ={}
    y = []
    x = []
        ...
        if conexion == 1:
            ...
            if contador != "Error":                             #ver que hace counter en el k64
               ...
               if self.ui.tabWidget.currentIndex() == 0:        # Es lineal?
                   altura = self.comm.getHeightLin()            #Lee Altura Lineal
                ...
                #   self.grafico(altura)
                   ...
                   if str(altura)[2:7] != "Error":
                       ...
                       if str(parametros)[2:7] != "Error":
                           self.ui.medidoStatusLineal.setText("Encoder " + parametros[4][:-1])
                   ...
                   if str(altura) != "Error":
                       if str(altura) == "ERROR":
                           ...
                           if str(parametros) != "Error":
                                ...
                                self.ui.medidoStatusRig.setText("Encoder " + parametros[5][:-1])
...
###############################################################################
    def clickEnviarPyM(self):
        ...
        if 'Operación Realizada.' in rta[0]:
